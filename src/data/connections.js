...
export const CONNECTIONS = [
  ...
  // ─── EXPANSION: REFORMASI HISTORY, COALITION NETWORKS, BISNIS TIES ──────────
  { from:"megawati",            to:"hasto_kristiyanto",   type:"rekan",           label:"Sekjen PDIP — langsung di bawah komando Megawati",                            strength:8  },
  ...
  { from:"cakimin",             to:"luluk_nur",           type:"rekan",           label:"Kader PKB — Luluk Nur legislatif DPR",                                        strength:6  },
  { from:"gibran",              to:"kaesang",             type:"keluarga",        label:"Kakak-Adik — keduanya putra Jokowi",                                          strength:9  },
  { from:"airlangga",           to:"adies_kadir",         type:"rekan",           label:"Kader Golkar — Adies Wakil Ketua DPR RI",                                     strength:7  },
  { from:"airlangga",           to:"nusron_wahid",        type:"rekan",           label:"Kader Golkar — Nusron Wahid Menteri ATR era Prabowo",                         strength:7  },
  { from:"airlangga",           to:"lodewijk_paulus",     type:"rekan",           label:"Kader Golkar — Lodewijk DPR leadership",                                      strength:6  },
  { from:"ahmad_syaikhu",       to:"anies",               type:"koalisi",         label:"PKS dukung Anies sejak Pilgub DKI 2017",                                      strength:8  },
  { from:"ahmad_syaikhu",       to:"cakimin",             type:"mantan-koalisi",  label:"PKS di Koalisi Anies-Cak Imin Pilpres 2024",                                  strength:7  },
  { from:"surya_paloh",         to:"johny_plate",         type:"rekan",           label:"Surya Paloh pemilik Nasdem — Johny Plate Sekjen sebelum KPK",                 strength:6  },
  { from:"hasto_kristiyanto",   to:"novel_baswedan",      type:"konflik",         label:"KPK vs PDIP — kasus Harun Masiku melibatkan Hasto",                           strength:7  },
  ...
  { from:"jokowi",              to:"ganjar",              type:"rekan",           label:"Jokowi dukung Ganjar sebagai penerus — kemudian kecewa",                      strength:5  },
  ...
  { from:"ahy",                 to:"prabowo",             type:"koalisi",         label:"Demokrat masuk KIM Plus — AHY jadi Menteri ATR",                              strength:8  },
  ...
  { from:"prabowo",             to:"agus_subiyanto",      type:"rekan",           label:"Agus Subiyanto Panglima TNI era Prabowo",                                     strength:8  },
  { from:"prabowo",             to:"erick_thohir",        type:"rekan",           label:"Erick Thohir Menteri BUMN berlanjut era Prabowo",                             strength:7  },
  { from:"prabowo",             to:"sjafrie",             type:"rekan",           label:"Sjafrie rekan jenderal TNI — Menhan era Prabowo",                             strength:8  },
  { from:"prabowo",             to:"sugiono",             type:"rekan",           label:"Sugiono Menlu Gerindra — diplomat pilihan Prabowo",                           strength:8  },
  { from:"jokowi",              to:"erick_thohir",        type:"rekan",           label:"Erick Thohir Menteri BUMN pilihan Jokowi 2019-2024",                          strength:8  },
  { from:"jokowi",              to:"mahfud_md",           type:"rekan",           label:"Mahfud MD Menkopolhukam 2019-2024 kemudian mundur",                           strength:7  },
  { from:"jokowi",              to:"airlangga",           type:"rekan",           label:"Airlangga Menko Perekonomian di kabinet Jokowi",                              strength:7  },
  ...
  { from:"jokowi",              to:"agus_subiyanto",      type:"rekan",           label:"Agus Subiyanto Panglima TNI terakhir pilihan Jokowi",                         strength:7  },
  { from:"jokowi",              to:"budi_arie",           type:"rekan",           label:"Budi Arie Menkominfo — aktivis ProJo pendukung Jokowi",                       strength:7  },
  { from:"jokowi",              to:"azwar_anas",          type:"rekan",           label:"Azwar Anas Menpan-RB di kabinet Jokowi",                                      strength:7  },
  { from:"jokowi",              to:"hasto_kristiyanto",   type:"rekan",           label:"Jokowi di bawah PDIP — Hasto Sekjen koordinasi",                              strength:6  },
  { from:"megawati",            to:"prananda",            type:"keluarga",        label:"Ibu-Anak — Prananda Maharani putra Megawati",                                 strength:10  },
  { from:"megawati",            to:"guruh",               type:"keluarga",        label:"Kakak-Adik — Guruh dan Megawati sama-sama anak Soekarno",                     strength:9  },
  { from:"megawati",            to:"pramono_anung",       type:"rekan",           label:"Pramono kader senior PDIP loyalis Megawati — Gubernur DKI",                   strength:8  },
  { from:"megawati",            to:"soekarno",            type:"keluarga",        label:"Anak-Bapak — Megawati putri Soekarno Proklamator",                            strength:10  },
  { from:"megawati",            to:"basuki",              type:"rekan",           label:"PDIP naungi Basuki — Gubernur DKI dari basis partai Mega",                    strength:7  },
  { from:"guruh",               to:"soekarno",            type:"keluarga",        label:"Anak-Bapak — Guruh anak bungsu Soekarno",                                     strength:10  },
  ...
  { from:"puan",                to:"prananda",            type:"keluarga",        label:"Adik-Kakak — keduanya putra-putri Megawati",                                  strength:9  },
  { from:"puan",                to:"basuki",              type:"konflik",         label:"PDIP kemudian jaga jarak dari Basuki — dukungan dialihkan",                   strength:3  },
  { from:"hasto",               to:"pramono_anung",       type:"rekan",           label:"Senior PDIP — koordinasi internal partai",                                    strength:7  },
  { from:"hasto",               to:"ganjar",              type:"rekan",           label:"Hasto Sekjen PDIP dukung Ganjar Capres 2024",                                 strength:7  },
  ...
  { from:"ganjar",              to:"hasto_kristiyanto",   type:"rekan",           label:"Ganjar Capres PDIP — Hasto Sekjen yang mendukungnya",                         strength:7  },
  { from:"pramono_anung",       to:"puan",                type:"rekan",           label:"Gubernur DKI PDIP koordinasi dengan Puan Ketua DPR",                          strength:7  },
  { from:"ganjar",              to:"mahfud_md",           type:"koalisi",         label:"Pasangan Capres-Cawapres PDIP di Pilpres 2024",                               strength:10  },
  { from:"mahfud_md",           to:"anies",               type:"rekan",           label:"Keduanya tokoh reformis — senada dalam kritik kebijakan",                     strength:5  },
  ...
  { from:"airlangga",           to:"agus_gumiwang",       type:"rekan",           label:"Sesama kader Golkar — Agus Gumiwang Menperin",                                strength:7  },
  ...
  { from:"alexander_marwata",   to:"novel_baswedan",      type:"rekan",           label:"Sesama pejabat KPK — Marwata dan Novel di lembaga sama",                      strength:6  },
  ...
  { from:"basuki",              to:"megawati",            type:"rekan",           label:"PDIP awalnya naungi Basuki — Gubernur DKI berbasis Mega",                     strength:6  },
  { from:"anies",               to:"megawati",            type:"konflik",         label:"PDIP tidak dukung Anies — beda koalisi di Pilpres 2024",                      strength:3  },
  { from:"yusril",              to:"jokowi",              type:"rekan",           label:"Yusril penasehat hukum dan konsultan era Jokowi",                             strength:6  },
  ...
  { from:"sufmi_dasco",         to:"ahmad_muzani",        type:"rekan",           label:"Dua pimpinan senior Gerindra di legislatif",                                  strength:8  },
