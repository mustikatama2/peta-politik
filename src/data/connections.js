export const CONNECTIONS = [
  ...
  // P0 fix — connections for 7 isolated persons (R37)
  { from:"jusuf_kalla", to:"susilo_bambang_yudhoyono", type:"kolega", label:"Pasangan SBY-JK 2004–2009", strength:9 },
  { from:"jusuf_kalla", to:"jokowi", type:"kolega", label:"Pasangan Jokowi-JK 2014–2019", strength:9 },
  { from:"jusuf_kalla", to:"prabowo", type:"konflik", label:"Rival di berbagai proses koalisi", strength:6 },
  { from:"jusuf_kalla", to:"megawati", type:"kolega", label:"JK bagian dari PDIP lalu Golkar — relasi panjang", strength:7 },
  { from:"jusuf_kalla", to:"bahlil", type:"mentor-murid", label:"JK senior Golkar Sulawesi — Bahlil junior Golkar Papua", strength:6 },
  { from:"tri_rismaharini", to:"megawati", type:"atasan-bawahan", label:"PDIP — Risma kader PDIP Surabaya, Mega ketua umum", strength:8 },
  { from:"tri_rismaharini", to:"puan", type:"kolega", label:"Sesama PDIP — Risma Mensos, Puan Ketua DPR", strength:7 },
  { from:"tri_rismaharini", to:"khofifah", type:"rival", label:"Rival Pilgub Jatim 2024 — Risma kalah dari Khofifah", strength:9 },
  { from:"tri_rismaharini", to:"jokowi", type:"atasan-bawahan", label:"Mensos di kabinet Jokowi 2020–2024", strength:9 },
  { from:"andika_perkasa", to:"hendropriyono", type:"keluarga", label:"Menantu Hendropriyono — ikatan keluarga-politik", strength:9 },
  { from:"andika_perkasa", to:"jokowi", type:"atasan-bawahan", label:"Jokowi menunjuk Andika sebagai Panglima TNI 2021", strength:9 },
  { from:"andika_perkasa", to:"prabowo", type:"rival", label:"Mantan Panglima TNI vs Presiden — beda kubu politik", strength:7 },
  { from:"andika_perkasa", to:"megawati", type:"kolega", label:"PDIP mendukung Andika di Pilgub Jateng 2024", strength:8 },
  { from:"hendropriyono", to:"jokowi", type:"rekan", label:"Mentor dan pendukung setia Jokowi sejak awal karier politik", strength:9 },
  { from:"hendropriyono", to:"megawati", type:"atasan-bawahan", label:"Kepala BIN di bawah Presiden Megawati 2001–2004", strength:9 },
  { from:"hendropriyono", to:"prabowo", type:"konflik", label:"Berbeda kubu militer dan politik", strength:6 },
  { from:"bima_arya", to:"jokowi", type:"kolega", label:"Walikota Bogor era Jokowi — kolaborasi pemerintah", strength:7 },
  { from:"bima_arya", to:"zulhas", type:"atasan-bawahan", label:"PAN — Bima Arya kader PAN, Zulhas Ketum PAN", strength:8 },
  { from:"bima_arya", to:"prabowo", type:"kolega", label:"PAN koalisi KIM Plus — Bima masuk kabinet Prabowo", strength:7 },
  { from:"bima_arya", to:"anies", type:"kolega", label:"Sesama Walikota Jabodetabek era 2017–2021", strength:6 },
  { from:"rafael_alun", to:"sri_mulyani", type:"konflik", label:"Rafael Alun mantan pejabat Kemenkeu — kasus gratifikasi", strength:8 },
  { from:"rafael_alun", to:"novel_baswedan", type:"rekan", label:"Keduanya terkait proses hukum dari lingkungan negara", strength:4 },
];
